...
def _markdown(artifact: str, change_id: str, title: str, flow_id: str | None = None) -> str:
    ...
    sections = {
        ...
        "verification": (
            ...
            "**PENDING**\n\n"
            "## Summary\n\n"
            "State how many Acceptance Criteria were verified, how many passed, how many failed, and whether Manual Evidence or Limitations apply.\n\n"
            "## Acceptance Coverage\n\n"
            "Reference each AC-xxx by id; do not reproduce its full text here.\n\n"
            "| Acceptance | Requirement | Result | Evidence |\n"
            "|---|---|---|---|\n"
            "| AC-001 | FR-001 | PENDING | TDD-001 |\n\n"
            "## Requirement Coverage\n\n"
