...
def test_fenced_task_example_is_not_completion_evidence(tmp_path: Path) -> None:
    change = _write_change(
        tmp_path,
        observable=True,
        specification="## Classification\n\nBehavior: behavioral\n\n### US-001 · First\n\n#### Acceptance Criteria\n##### AC-001\n",
    ...
    (change / "tasks.md").write_text("```md\n- [x] T-001 Example\n```\n", encoding="utf-8")
    (change / "verification.md").write_text("| AC-001 | FR-001 | PASS | real |\n", encoding="utf-8")
    (change / "traceability.yml").write_text(
        "schema: forge/traceability@1\nchange: CHG-0050\nrequirements: {}\n"
        "stories:\n  US-001:\n    tasks: [T-001]\n    verification: [AC-001]\n",
        encoding="utf-8",
    ...
    assert any("without completed repository-native evidence" in finding.message for finding in findings)


def test_failed_verification_result_is_not_pass_evidence(tmp_path: Path) -> None:
    change = _write_change(
        tmp_path,
        observable=True,
        specification="## Classification\n\nBehavior: behavioral\n\n### US-001 · First\n\n#### Acceptance Criteria\n##### AC-001\n",
    ...
    (change / "tasks.md").write_text("- [x] T-001 Example\n", encoding="utf-8")
    (change / "verification.md").write_text("| AC-001 | FR-001 | FAIL | PASS |\n", encoding="utf-8")
    (change / "traceability.yml").write_text(
        "schema: forge/traceability@1\nchange: CHG-0050\nrequirements: {}\n"
        "stories:\n  US-001:\n    tasks: [T-001]\n    verification: [AC-001]\n",
        encoding="utf-8",
